...
aws cloudwatch put-metric-alarm --alarm-name AddCapacity --metric-name CPUUtilization --namespace AWS/EC2 --statistic Average --period 60 --threshold 30 --comparison-operator GreaterThanOrEqualToThreshold --dimensions "Name=AutoScalingGroup,Value=itmo544extendedautoscalinggroup2" --evaluation-periods 1 --alarm-actions arn:aws:autoscaling:us-west-2:089423386606:scalingPolicy:cc88d707-2094-4129-9525-f91079eec50f:autoScalingGroupName/Project1-auto-scaling-group-2:policyName/scalingpolicytest
