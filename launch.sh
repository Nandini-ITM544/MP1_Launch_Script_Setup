...
aws autoscaling create-launch-configuration --launch-configuration-name Project1-launch-config --image-id $1 --key-name $4 --security-groups $5 --instance-type $3 --user-data /home/controller/Documents/MP1_Environment_Setup_Final/install-env.sh --iam-instance-profile $7
